...
DF(T)=\exp[-r(T)T].
\end{equation}
A par yield is the coupon rate making a specified bond worth face value. The term structure describes rates across maturities, or tenors; a yield curve represents it.
