...
Checked on 15 September 2026. There are 16 references in `references.bib`.
...
| `treasuryCmt` | [U.S. Department of the Treasury FAQ](https://home.treasury.gov/policy-issues/financing-the-government/interest-rate-statistics/interest-rates-frequently-asked-questions) confirms that CMT yields are read from the Treasury's daily par yield curve, use bond-equivalent quotation and are not Treasury zero-coupon curve rates. The page supplies no publication date, so none is recorded. | Chapter 2: authoritative support for the CMT/par-versus-zero distinction only. No Treasury observations are used. |
...
| `tuckman2011` | [Wiley third-edition record](https://uat.store.wiley.com/en-us/fixed-income-securities-tools-for-today%27s-markets-3rd-edition-p-9781118133965) confirms Bruce Tuckman, Angel Serrat, title, third edition and October 2011; [Wiley companion](https://bcs.wiley.com/he-bcs/Books?action=index&bcsId=6676&itemId=0470904038) corroborates authors/edition. | Chapters 1–3: bond cash flows, price/yield, discount factors, spot versus YTM, duration, convexity and DV01. Publisher description supports the reading allocation; consult the actual relevant chapters before attaching detailed page citations. No claim of full-text access. |
...
NBER version. Gilli, Große and Schumann's opening modelling/calibration
...
audit confirms that every key resolves and all 16 entries are cited.
